...
import com.ourproject.ui.book.adapters.material.MaterialDataAdapter;
import com.ourproject.ui.book.bean.material.DataBean;
import com.ourproject.ui.book.bean.material.DataBeanX;
...
public class MaterialAdapter extends RecyclerView.Adapter<MaterialAdapter.ViewHolder>{
    ...
    public MaterialAdapter(Context context, List<DataBeanX> dataX) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        MaterialDataAdapter adapter = new MaterialDataAdapter(context, data, image);
